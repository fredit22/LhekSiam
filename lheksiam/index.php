...
<head>
    ...
    <title>Welcome To | Leksiam</title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Welcome To | Leksiam</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        <a href="pages/stock_import.php">
                            <i class="material-icons">text_fields</i>
                            <span>Receive Order</span>
                        </a>
                    </li>
                    <li>
                        <a href="pages/stock_export.php">
                            <i class="material-icons">text_fields</i>
                            <span>Shipping Order</span>
                        </a>
                    </li>
                    <li>
                        <a href="pages/product_master.php">
                            <i class="material-icons">text_fields</i>
                    ...
                    <li>
                        <a href="pages/report_balance.php">
                            <i class="material-icons">text_fields</i>
