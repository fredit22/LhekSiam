        ...
        <center><table>
          <div class="search-container">
            <tr>
                ...
                <td><input type="text" name="id" id="id" class="form-control" style=" width : 200px" /></td>

                <td></td>


                <td colspan="4" align="right"><label> PRODUCT NAME :&nbsp;&nbsp;</label></td>
                <td><input type="text" class="form-control date" name="name" id="name" style=" width : 200px"/><br></td>
            </tr></div>
           <!--  ======================================= -->
            <tr>
