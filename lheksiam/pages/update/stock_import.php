...
<!--                    <li>
    ...
    <section class="content">
        ...
        <table>
            <tr>
                <td><label>Invoice No :</label><br></td>
                <td><input type="text" name="invno" id="invno" class="form-control"/><br></td>

                <td colspan="2" align="right"><label> Receive Date :&nbsp;&nbsp;</label></td>
                <td><input type="date" class="form-control date" name="recdate" id="recdate" /><br></td>
            </tr>
           <!--  ======================================= -->
            <tr>
                ...
                <td>&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="document.getElementById('id01').style.display='block'" class="btn btn-warning">Add Cutomer</button></td>
            ...
            <!--  ======================================= -->
            <tr>
                <td> <label ><br><br>Packing List No :&nbsp;&nbsp;</label></td>
                <td><br><input type="text" class="form-control" name="pckno" id="pckno"></td>
                <td colspan="1"></td>
                <td><label ><br><br>License Plate :&nbsp;&nbsp;</label></td>
            ...
            <!-- #END# Body Copy -->
                   ...
                   <table class="table table-bordered" >
                    ...
                    <tr>
                        <div class="col-sm-3">
                            <td>
                            <select class="form-control" id="product<?php echo $j ?>" name="product<?php echo $j ?>" style=" width: 170px;">
                        ...
                        <div class="col-sm-3">
                            <td><input type="text" class="form-control" name="P_Name<?php echo $j ?>" id="P_Name<?php echo $j ?>"></td>
                        </div>
                        ...
                        <div class="col-sm-1">
                        <td>
                            <select class="form-control" id="warehouse<?php echo $j ?>" name="warehouse<?php echo $j ?>" style=" width: 170px;">
                        ...
                        <div class="col-sm-1">
                            <td><input class="form-control" name="Weight<?php echo $j ?>" id="Weight<?php echo $j ?>"></td>
                        </div>
