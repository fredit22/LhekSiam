...
$sql = $sql." (SUPPLIER_ID,SUPPLIER_NAME,EFFECTIVE_START_DATE,EFFECTIVE_END_DATE,ADDRESS_1,ADDRESS_2) " ;
$sql = $sql." VALUES " ;
$sql = $sql." ( \"".$Number."\",\"".$SupName."\",\"".$startdate."\",\"".$enddate."\",\"".$add1."\",\"".$add2."\") ";
echo " <BR> ".$sql." <BR> " ;
}
